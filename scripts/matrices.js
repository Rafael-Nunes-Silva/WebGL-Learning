...
function Rotate3D(mat4, rot){
    ...
    return MulMat4x4(mat4, MulMat4x4(zRotMat, MulMat4x4(yRotMat, xRotMat)));
}
...
function RotateMat4(mat, rot){
    ...
    return AddMat4x4(mat, MulMat4x4(MulMat4x4(xRotMat, yRotMat), zRotMat));
}
